...
@Mod(value = CraftableMusic.MOD_ID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = CraftableMusic.MOD_ID, value = Dist.CLIENT)
public class CraftableMusicClient {
    public CraftableMusicClient(ModContainer container) {
